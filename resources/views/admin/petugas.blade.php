...
<div class="container mt-4">
    ...
    <div>
        <h4 style="margin-top: 20px; margin-bottom: 20px; text-align:center">Data Petugas</h4>
        {{-- <div class="pb-1">
        ...
        <tbody>
           {{-- {{dd($data)}} --}}
            ...
            <tr>
                ...
                {{-- <td>{{ $item->status }}</td> --}}
                <td>
                    <a href="{{ route('tambahpengguna.edit', $item->id) }}" class="btn btn-warning btn-sm">Edit</a>
