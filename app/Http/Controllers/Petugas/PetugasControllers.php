...
class PetugasControllers extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('petugas.dashboard',compact('data','kategori','penerbit','pengarang'))->with('data',$data);
    }
    ...
    public function create()
    {
        ...
        $penerbit = penerbit::all();
        $pengarang = pengarang::all();
        return view('petugas.createbuku',compact('kategori','penerbit','pengarang'));
    }
    ...
    public function store(Request $request)
{
    ...
    public function edit(string $id)
    {
        ...
        return view('petugas.bukuedit',compact('kategori','penerbit'))->with('data',$data);
    }
